Shader "Fur/Shell/Lit_Alpha" // Renamed for clarity
{
...
Properties
{
    ...
    _AlphaMap("Alpha Map", 2D) = "white" {} // Added Alpha Map property
    ...
    _AlphaCutout("Alpha Cutout", Range(0.0, 1.0)) = 0.5 // Default cutout changed to 0.5
...
SubShader
{
    Tags
    {
        ...
        "Queue" = "AlphaTest"               // Added for correct sorting
    ...
    // ForwardLit Pass remains the same here
    Pass
    {
        Name "ForwardLit"
    ...
    // Other passes (DepthOnly, DepthNormals, ShadowCaster) remain the same here...
    Pass
    {
        Name "DepthOnly"
